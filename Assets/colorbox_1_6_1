...
(function (t, e, i) {
	...
	function p() {
		y || (V = !1, E = t(i), y = n(se).attr({
			...
			"float": "left"
		}), L = n(se, !1, "position:absolute; width:9999px; visibility:hidden; display:none; max-width:none;"), O = K.add(P).add(F).add(R)),
	...
	function w() {
		...
		100), _.get("inline")) {
			...
			d === le && setTimeout(function () {
				...
				W[1] && (_.get("loop") || W[A + 1]) && (U.style.cursor = "pointer", t(U).bind("click." + Z, function () {
					J.next()
				})),
	...
	J.next = function () { ! q && W[1] && (_.get("loop") || W[A + 1]) && (A = h(1), f(W[A]))
	},
	J.prev = function () { ! q && W[1] && (_.get("loop") || A) && (A = h( - 1), f(W[A]))
	},
	J.close = function () {
